...
import fragments.Negocio.MyHome;
import fragments.Negocio.Logout;
import models.NavItem;

public class PanelNegocio extends ActionBarActivity{
    ...
    private TextView tvEmailNegocio;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_panel_negocio);

        //Recibimos los datos del LoginActivity que manda por Intent
        final Intent intent = getIntent();
        String usuario = intent.getStringExtra("usuario");

        tvEmailNegocio = (TextView)findViewById(R.id.tvEmailNegocio);
        tvEmailNegocio.setText(usuario);
        ...
        lvNav.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (id == 1){
                    ...
                    startActivity(new Intent(PanelNegocio.this,LoginActivity.class));
                    finish();
                }
