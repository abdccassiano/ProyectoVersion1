...
import fragments.Vendedor.MyHome;
import fragments.Vendedor.Logout;
import models.NavItem;

public class PanelVendedor extends ActionBarActivity{
    ...
    private TextView tvEmailVendedor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvEmailVendedor = (TextView)findViewById(R.id.tvEmailVendedor);
        tvEmailVendedor.setText(usuario);
        ...
        lvNav.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (id == 1){
                    ...
                    startActivity(new Intent(PanelVendedor.this,LoginActivity.class));
                    finish();
                }
