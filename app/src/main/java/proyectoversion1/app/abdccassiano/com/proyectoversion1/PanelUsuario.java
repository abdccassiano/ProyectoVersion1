...
import fragments.Usuario.MyHome;
import fragments.Usuario.Logout;
import models.NavItem;

public class PanelUsuario extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvEmailUsuario.setText(usuario);
        ...
        lvNav.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (id == 1){
                    ...
                    startActivity(new Intent(PanelUsuario.this,LoginActivity.class));
                    finish();
                }
